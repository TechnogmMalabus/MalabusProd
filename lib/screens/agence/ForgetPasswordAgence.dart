...
class ForgetPasswordAgence extends StatefulWidget {
  @override
  State<ForgetPasswordAgence> createState() => _ForgetPasswordAgenceState();
}

class _ForgetPasswordAgenceState extends State<ForgetPasswordAgence> {
  String email = '';
  String errormsg = "";
